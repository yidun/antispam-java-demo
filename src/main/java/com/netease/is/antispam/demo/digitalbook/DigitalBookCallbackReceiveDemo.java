 ...
 */
@RestController
public class DigitalBookCallbackReceiveDemo {
     ...
     */
    @PostMapping(value = "/digitalBook/callback/receive")
    public void digitalBookCallbackReceive(HttpServletRequest request) throws UnsupportedEncodingException {
