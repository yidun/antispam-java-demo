...
/**
 * 调用易盾反垃圾云服务敏感词查询接口API示例，该示例依赖以下jar包： 1. httpclient，用于发送http请求 2. commons-codec，使用md5算法生成签名信息，详细见SignatureUtils.java 3.
 * gson，用于做json解析
 *
 * @author hzgaomin
 * @version 2020年06月08日
...
public class KeywordQueryAPIDemo {
    ...
    /** 易盾反垃圾云服务敏感词批量提交接口地址 */
    private final static String API_URL = "https://as.dun.163.com/v1/keyword/query";
