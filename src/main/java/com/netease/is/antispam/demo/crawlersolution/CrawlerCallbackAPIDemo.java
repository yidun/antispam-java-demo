/*
 * @(#) CrawlerCallbackAPIDemo.java 2020-04-23
 *
...
/**
 * 调用易盾反垃圾云服务网站检测解决方案结果获取接口API实例
 *
 * @author huangwu
 * @version 2020-04-23
 */
public class CrawlerCallbackAPIDemo {
    /** 产品密钥ID，产品标识 */
    private final static String SECRETID = "your_secret_id";
    /** 产品私有密钥，服务端生成签名信息使用，请严格保管，避免泄露 */
    private final static String SECRETKEY = "your_secret_key";
    /** 易盾反垃圾云服务文档检测结果获取接口地址 */
    private final static String API_URL = "https://as.dun.163yun.com/v1/crawler/callback/results";
