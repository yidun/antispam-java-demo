 ...
 */
@RestController
public class ReportCallbackReceiveDemo {
     ...
     */
    @PostMapping(value = "/report/callback/receive")
    public void reportCallbackReceive(HttpServletRequest request) throws UnsupportedEncodingException {
