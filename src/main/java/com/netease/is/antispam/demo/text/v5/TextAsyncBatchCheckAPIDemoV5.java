...
/**
 * 调用易盾反垃圾云服务文本V5批量异步检测接口API示例，该示例依赖以下jar包： 1. httpclient，用于发送http请求 2.
 * commons-codec，使用md5算法生成签名信息，详细见SignatureUtils.java 3. gson，用于做json解析
 *
 * @author yidun
 * @version 2021年08月31日
 */
public class TextAsyncBatchCheckAPIDemoV5 {
    /**
     * 产品密钥ID，产品标识
     */
     ...
     * 易盾反垃圾云服务文本在线检测接口地址
     */
    private final static String API_URL = "https://as.dun.163.com/v5/text/async-batch-check";
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        text1.addProperty("content", "易盾v5批量异步检测接口测试内容!");
        ...
        text2.addProperty("content", "易盾v5批量异步检测接口测试内容!");
        textArray.add(text2);
