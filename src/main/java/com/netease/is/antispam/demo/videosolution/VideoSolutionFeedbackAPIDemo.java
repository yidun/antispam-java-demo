 ...
 */
public class VideoSolutionFeedbackAPIDemo {
    /**
     * 产品密钥ID，产品标识
     */
    private final static String SECRETID = "6eff76edc8f2851532beac8ca6f95db6";
    /**
     * 产品私有密钥，服务端生成签名信息使用，请严格保管，避免泄露
     */
    private final static String SECRETKEY = "1ea97a431946708324cc6b1730d3cfff";

    /**
     * 易盾反垃圾云服务查询点播语音结果接口地址
     */
    private final static String API_URL = "https://as.dun.163.com/v1/videosolution/feedback";
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        feedback.addProperty("taskId", "g03sb8i4d2bj9zhn99z20c0h02009zev");
        JsonArray tags = new JsonArray();
        tags.add("tag1");
        tags.add("tag2");
        feedback.add("tags", tags);
