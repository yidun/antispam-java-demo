/*
 * @(#) ReportSolutionQueryAPIDemo.java 2021-09-03
 *
 ...
 * @version 2021-09-03
 */
public class ReportSolutionQueryAPIDemo {
     ...
     * 举报解决方案结果查询接口
     */
    private final static String API_URL = "https://as.dun.163.com/v1/report/callback/query";
    /**
    ...
    public static void main(String[] args) {
        ...
        params.put("taskIds", "['6uyvxto4e7g9i6jx10utuhig05009pk8','1346778']");
        // 预处理参数
