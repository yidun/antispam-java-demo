...
/**
 * 调用易盾反垃圾云服务网站检测解决方案公众号提交接口API实例
 */
public class OfficialAccountJobSubmitAPIDemo {
    /** 产品密钥ID，产品标识 */
    private final static String SECRETID = "your_secret_id";
    /** 产品私有密钥，服务端生成签名信息使用，请严格保管，避免泄露 */
    private final static String SECRETKEY = "your_secret_key";
    /** 易盾反垃圾云服务在线提交地址 */
    private final static String API_URL = "http://as.dun.163.com/v1/official-accounts/job/submit";
    ...
    public static void main(String[] args) throws Exception {
        ...
        params.put("wechatAccount", "123456");
        params.put("officialAccountName", "xxx公众号");
