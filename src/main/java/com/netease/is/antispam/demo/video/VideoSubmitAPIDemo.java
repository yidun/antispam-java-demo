...
/**
 * 调用易盾反垃圾云服务视频信息提交接口API示例，该示例依赖以下jar包： 1. httpclient，用于发送http请求 2. commons-codec，使用md5算法生成签名信息，详细见SignatureUtils.java
 * 3. gson，用于做json解析
 *
 * @author hzdingyong
 * @version 2016年8月23日
...
public class VideoSubmitAPIDemo {
     ...
     * 易盾反垃圾云服务视频信息提交接口地址
     */
    private final static String API_URL = "https://as.dun.163.com/v4/video/submit";
    /**
